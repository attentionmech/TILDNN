...
I did a simple experiment of asking LLMs do a random walk. I did the test with open source llama3.1/2 and gemma2 series since those are the ones I heavily use for automation and other stuff. My general expectation was that as tempreture will grow the random walk will keep growing more. But somehow the gemma2:9b model is behaving weirdly. That is what I am investigating. 
