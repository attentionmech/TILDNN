...
1. Even with a explicit instruction why can't a LLM produce a random walk at temperature = 0
2. What the f is happening with gemma2:9b

Nonetheless enjoy the visuals for others in the following tables-
